...
import "./styles.css";
import Im from "../images/AntonyFromPerfil.webp";
    ...
    <div className="personal-info-contenedor">
      ...
      <div className="personal-info-text">
        ...
        <p>
          ...
          ser profesional con mi trabajo, aprender de mis errores y sobre todo,
          dar la mejor experiencia al usuario. Me encanta la optimización del
          tiempo, ya que lo aplico en mi vida diaria y, por supuesto, al código.
        </p>
        </div>
